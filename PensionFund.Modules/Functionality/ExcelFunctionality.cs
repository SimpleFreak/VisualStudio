...
namespace PensionFund.Modules.Functionality
{
    public class ExcelFunctionality
    {
        ...
        public static void WriteExcelFile(string filePath)
        {
            ...
            Cell cellA1 = new() { CellReference = "A1", DataType = CellValues.String,
                InnerXml = "Имя" };
            Cell cellB1 = new() { CellReference = "B1", DataType = CellValues.String,
                InnerXml = "Возраст" };
            row_1.Append(cellA1);
            row_1.Append(cellB1);
            ...
            Cell cellA2 = new() { CellReference = "A2", DataType = CellValues.String,
                InnerXml = "Иван" };
            Cell cellB2 = new() { CellReference = "B2", DataType = CellValues.Number,
                InnerXml = "25"};
            row_2.Append(cellA2);
            row_2.Append(cellB2);
